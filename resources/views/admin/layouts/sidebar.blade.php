<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li
                class="dropdown {{ setActive(['admin.brand.*', 'admin.products.*', 'admin.product-image-gallery.*', 'admin.products-variant.*', 'admin.products-variant-item.*', 'admin.seller-products.*', 'admin.seller-pending-products.*']) }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li
                        class="{{ setActive(['admin.products.*', 'admin.product-image-gallery.*', 'admin.products-variant.*', 'admin.products-variant-item.*']) }}">
